    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div class="space-y-6">
        <section aria-label="Environmental conditions">
          <EnvironmentalBox v-if="showVersion === 1" :policy="envData" :loading="envLoading" :error="envError" />
          <EnvironmentalBoxV2 v-else-if="showVersion === 2" :policy="envData" :loading="envLoading" :error="envError" />
...
import EnvironmentalBox from './components/EnvironmentalBox.vue';
